...
Script_PATH1="~/Debian/Master.sh"
Script_PATH2="~/Debian/Chunk.sh"
Script_PATH3="~/Debian/Chunk_MetaLogger.sh"
Script_PATH4="~/Debian/Shadow.sh"
Script_PATH5="~/Debian/Client.sh"
Script_PATH6="~/Debian/host.sh"
Script_PATH7="~/Debian/Network.sh"
Script_PATH8="~/Debian/ssh.sh"
